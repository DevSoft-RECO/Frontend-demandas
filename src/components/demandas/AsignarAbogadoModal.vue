        ...
        <div class="p-6 max-h-[75vh] overflow-y-auto custom-scrollbar">
          ...
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Plantilla de Pagos (Preset) *</label>
            ...
            <div v-if="form.id_preset > 0" class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-gray-50 dark:bg-gray-900/40 rounded-xl border border-gray-100 dark:border-gray-700">
                <div>

    ...
    */
    ...
    const items = [
        ...
        },
        {
            ...
            show: true,
            children: [
                { label: 'Gestión de Demandas', route: '/admin/demandas/lista', show: true },
                { label: 'Seguimiento Legal', route: '/admin/abogado/seguimiento', show: true },
                { label: 'Gestión de Pagos', route: '/admin/finanzas/pagos', show: true }
            ]
        },
